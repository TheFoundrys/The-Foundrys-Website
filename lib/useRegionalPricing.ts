...
export const COURSE_PRICING: CoursePricing = {
    ...
    aiEngineer: {
        original: { INR: '1,00,000', USD: '1,000' },
    ...
    zeroToOneLLM: {
        original: { INR: '1,50,000', USD: '1,500' },
        freshers: { INR: '1,50,000', USD: '1,500' },
        zeroToTwo: { INR: '1,80,000', USD: '1,800' },
        twoToFive: { INR: '2,10,000', USD: '2,100' },
    },
