        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="flex-1 text-left">
              ...
              >
                The Foundry’s Certified Innovator (FCI) Fellowship is an elite, 4-week intensive residency designed for students in their final year and graduates. This is not a classroom experience; it is a professional-grade incubator.
              </motion.p>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
             <div>
                ...
                <h2 className="text-3xl md:text-5xl font-bold mb-6 leading-tight">
                    Why the FCI? <br/><span className="text-neutral-500">Because Knowledge without Agency is Obsolete.</span>
                </h2>
                ...
                <div className="flex flex-col gap-4">
                    <div className="flex items-center justify-between p-4 bg-neutral-900/50 rounded-lg border border-neutral-700 opacity-60">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="font-medium">Standardized Testing</span>
                        </div>
                        <span className="text-xs uppercase tracking-wider text-neutral-500">Static</span>
                    </div>
                    ...
                    <div className="flex items-center justify-between p-6 bg-gradient-to-r from-blue-500/10 to-transparent rounded-lg border border-blue-500/30">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="font-bold text-white">Venture Building</span>
                        </div>
                        <span className="text-xs uppercase tracking-wider text-transparent bg-clip-text bg-[linear-gradient(to_right_bottom,lab(44.0605_29.0279_-86.0352)_0%,lab(23.3911_24.6978_-50.4718)_100%)] font-bold">Dynamic</span>
                    </div>
                </div>
