             ...
             <div className="relative z-20 px-4 -mt-14 mb-12">
                <div className="mx-auto max-w-7xl">
                    <div className="bg-white rounded-2xl shadow-xl border border-slate-200 p-6 md:p-8 flex flex-col lg:flex-row items-center justify-between gap-6 md:gap-12">
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-12 flex-1 text-center lg:text-left w-full text-slate-900">
                            <div>
                        ...
                        <div className="flex gap-3 w-full lg:w-auto">
                            <Link href="/payment?course=schoolOfQuantum&type=freshers" className="flex-1 lg:flex-none text-center px-8 py-3 bg-violet-600 text-white font-bold rounded-lg hover:bg-violet-500 transition-all shadow-lg active:scale-95 whitespace-nowrap">
                                Enroll Now
                            </Link>
