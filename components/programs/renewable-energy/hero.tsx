  ...
  return (
    <section className="relative pt-32 pb-32 px-4 min-h-[85vh] flex flex-col justify-center bg-slate-900 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto max-w-6xl">
            ...
            >
                Graduate as an <br/>
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-400">Energy Architect</span> with <br/>
                Mastery, Vision & <br/>
                Global Impact.
            </motion.h1>
            ...
            >
                Not just panels. A 3-year immersion into Smart Grids, Storage Systems, and Policy. 
