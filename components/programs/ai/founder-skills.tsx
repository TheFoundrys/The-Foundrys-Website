...
import { Cpu, Network, Database, BrainCircuit, Code2, Layers, Container } from "lucide-react";
            ...
            <div className="container mx-auto max-w-6xl relative z-10">
                <div className="flex flex-col md:flex-row gap-16 items-center">
                    ...
                    <div className="md:w-1/2">
                        <span className="text-blue-400 font-mono font-bold tracking-widest text-sm uppercase mb-4 block">Core Competencies</span>
                        <h2 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
                            Engineering Skills <br/> That Matter.
                        </h2>
                        ...
                        <div className="space-y-4">
                            {[
                                { icon:  BrainCircuit, label: "Neural Architecture Search" },
                                { icon:  Database, label: "Data Pipeline Engineering" },
                                { icon:  Network, label: "Distributed Training" },
                                { icon:  Code2, label: "Kernel Optimization (CUDA)" },
                            ].map((s, i) => (
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            >
                                <div className="flex justify-between items-start mb-4">
                                    <div className="p-3 bg-blue-500 rounded-xl"><Cpu className="text-white" /></div>
                                    <span className="text-xs font-mono text-blue-300">CORE MASTERY</span>
                                </div>
                                <div className="space-y-4">
                                    {[
                                        { label: "TRANSFORMERS", val: "95%", color: "bg-blue-500" },
                                        { label: "COMPUTER VISION", val: "90%", color: "bg-blue-400" },
                                        { label: "REINFORCEMENT LEARNING", val: "85%", color: "bg-indigo-500" },
                                        { label: "MLOPS & CI/CD", val: "88%", color: "bg-purple-500" }
                                    ].map((skill, i) => (
                                        <div key={i}>
                            ...
                            {/* Card 2: Deployment */}
                             <motion.div 
                                ...
                                whileHover={{ scale: 1.05 }}
                                className="bg-gradient-to-br from-purple-900/80 to-slate-900 p-6 rounded-3xl border border-white/10"
                            >
                                <div className="text-4xl font-bold text-white mb-1">&lt;10ms</div>
                                <div className="text-xs text-slate-400 uppercase tracking-wider font-bold">Inference Latency</div>
                                <div className="mt-4 text-sm text-slate-300">Optimization for real-time edge deployment.</div>
                            </motion.div>
                            ...
                            >
                                ...
                                <div className="font-bold text-3xl leading-tight mb-1">IEEE</div>
                                <div className="text-xs text-slate-500 font-bold">Standard Research</div>
                            </motion.div>
                        </div>
                    </div>
                </div>
