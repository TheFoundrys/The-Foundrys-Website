    ...
    return (
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-slate-950 pt-20">
            ...
            <div className="container mx-auto px-4 relative z-10 text-center">
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                        ...
                        <button
                            ...
                            className="px-8 py-4 bg-white/5 hover:bg-white/10 text-white border border-white/10 rounded-full font-medium backdrop-blur-sm transition-all flex items-center gap-2"
                        >
                            View Syllabus
                ...
                {/* Cyber Stats/Floating Elements could go here */}
            </div>
        </section>
    );
}
