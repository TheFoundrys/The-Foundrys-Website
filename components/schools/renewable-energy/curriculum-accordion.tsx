...
import { renewableEnergyCurriculum } from "@/data/renewable-energy-curriculum";

export function RenewableEnergyCurriculumAccordion() {
        ...
        <section id="syllabus" className="py-24 px-4 bg-white relative overflow-hidden">
            ...
            <div className="container mx-auto max-w-4xl relative z-10">
                <div className="text-center mb-16">
                     <span className="text-green-600 font-bold tracking-widest text-sm uppercase mb-4 block">The Syllabus</span>
                     <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6">Zero to Energy Architect. <br/><span className="text-slate-400">Step by Step.</span></h2>
                </div>
                                ...
                                {openYear === yearIdx && (
                                    ...
                                    >
                                        <div className="p-6 md:p-8 border-t border-slate-100">
                                            <p className="text-slate-600 italic mb-8 border-l-4 border-green-200 pl-4 py-2">{year.goal}</p>
                                            ...
                                            <div className="space-y-12">
                                                {year.semesters.map((sem, semIdx) => (
                                                    <div key={sem.id} className="relative pl-8 md:pl-12 border-l border-slate-200 pb-12 last:pb-0 last:border-0">
                                                        <div className="absolute top-0 left-[-6px] w-3 h-3 rounded-full bg-green-600 shadow-[0_0_0_4px_white]" />
                                                        ...
                                                        <div className="bg-slate-900 rounded-2xl p-6 md:p-8 text-white relative overflow-hidden group">
                                                            <div className="absolute top-0 right-0 p-32 bg-green-600/20 rounded-full blur-[80px] group-hover:bg-green-600/30 transition-colors" />
