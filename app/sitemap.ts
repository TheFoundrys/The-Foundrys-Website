...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
    ...
    const staticRoutes = [
        ...
        '/programs/fellow-executive',
        '/programs/fellow-executive/ai-leadership',
        '/programs/fellow-executive/delivering-in-age-of-ai',
        '/programs/fellow-executive/strategic-impact',
