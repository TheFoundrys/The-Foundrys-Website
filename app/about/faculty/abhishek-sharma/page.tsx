...
import { Linkedin, ArrowLeft, Zap, BookOpen, BarChart3, Target, GraduationCap, Database, TrendingUp } from "lucide-react";
                            ...
                            >
                                <div>
                                    ...
                                    <p className="text-base sm:text-lg text-slate-600 font-medium italic">
                                        Driving Enterprise Decisions Through Precision Data Architecture & Analytics
                                    </p>
                                </div>
                                ...
                                <div className="flex flex-wrap gap-2.5 pt-2">
                                    <div className="flex items-center gap-2 px-3 py-1.5 bg-[#F1F1EC] border border-slate-200/80 text-xs font-mono text-slate-700 shadow-xs">
                                        <BarChart3 size={14} className="text-[#002f86]" /> 8+ Yrs Analytics
                                    </div>
                                    <div className="flex items-center gap-2 px-3 py-1.5 bg-[#F1F1EC] border border-slate-200/80 text-xs font-mono text-slate-700 shadow-xs">
                                        <Database size={14} className="text-[#002f86]" /> Data Modeling
                                    </div>
                                    <div className="flex items-center gap-2 px-3 py-1.5 bg-[#F1F1EC] border border-slate-200/80 text-xs font-mono text-slate-700 shadow-xs">
                                        <TrendingUp size={14} className="text-[#002f86]" /> Business Intelligence
                                    </div>
                                </div>
                            </motion.div>
                        </div>
