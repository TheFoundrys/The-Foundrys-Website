...
import { ArrowLeft, Code, Cpu, Layers, Terminal, Laptop, Rocket, Globe } from "lucide-react";
import Link from "next/link";

export default function SaiPramodProfile() {
    return (
                        ...
                        <div className="flex flex-col lg:flex-row gap-10 lg:gap-14 items-start">
                            ...
                            >
                                <div className="aspect-[3/4] relative overflow-hidden shadow-md bg-white border border-slate-200/80">
                                    <Image
                                        src="/images/testimonials/saipramod.jpeg"
                                        alt="Sai Pramod"
                                        fill
                                        priority
                            ...
                            >
                                <div>
                                    ...
                                    <p className="text-base sm:text-lg text-slate-600 font-medium italic">
                                        Full-Stack Software Engineering, AI Systems Integration & Product Development
                                    </p>
                                </div>
                ...
                <section className="p-6 sm:p-10 md:p-12 pt-5 sm:pt-6 md:pt-6 pb-5 sm:pb-6 md:pb-6 bg-white border-b border-slate-200/50">
                    <div className="max-w-4xl space-y-6">
                        ...
                        <p className="text-slate-700 text-sm md:text-base leading-relaxed font-sans">
                            Sai Pramod is a Software Developer at The Foundry&apos;s specializing in modern full-stack development, AI engineering integration, and building robust software solutions. Driven by a strong focus on practical, hands-on creation, he translates complex algorithms into scalable, user-centric software products.
                        </p>
                        <p className="text-slate-700 text-sm md:text-base leading-relaxed font-sans">
                            Under the mentorship of Vishwanath Akuthota, Sai Pramod developed deep expertise in AI engineering, machine learning pipelines, and model training through a &quot;learning by doing&quot; philosophy. He continuously applies these capabilities to deliver high-quality code and innovative deep tech solutions.
                        </p>
                    </div>
                </section>
                    ...
                    <div className="max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            ...
                            <div className="space-y-2.5 text-xs md:text-sm text-slate-700 font-sans">
                                <p className="p-3.5 bg-white border border-slate-200/80 shadow-xs">Building scalable full-stack web and cloud applications</p>
                                <p className="p-3.5 bg-white border border-slate-200/80 shadow-xs">Integrating machine learning models & AI engineering workflows</p>
                                <p className="p-3.5 bg-white border border-slate-200/80 shadow-xs">Implementing clean software design patterns & modular code</p>
                                <p className="p-3.5 bg-white border border-slate-200/80 shadow-xs">Developing user-focused deep tech platforms and tools</p>
                            </div>
                        </div>
                        <div>
                            <h3 className="font-serif text-xl font-bold text-[#002f86] mb-4 flex items-center gap-2">
                            ...
                            <div className="space-y-2.5 text-xs md:text-sm text-slate-700 font-sans">
                                <p className="p-3.5 bg-white border border-slate-200/80 shadow-xs">Software Architecture & Development</p>
                                <p className="p-3.5 bg-white border border-slate-200/80 shadow-xs">AI & Machine Learning Applications</p>
                                <p className="p-3.5 bg-white border border-slate-200/80 shadow-xs">Rapid Prototyping & Product Engineering</p>
                                <p className="p-3.5 bg-white border border-slate-200/80 shadow-xs">System Optimization & Performance Tuning</p>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="max-w-4xl space-y-8">
                        <div>
                            ...
                            <p className="font-serif italic text-base md:text-xl text-slate-700 leading-relaxed">
                                &quot;Building software isn&apos;t just about writing code; it&apos;s about solving complex real-world problems through continuous learning, practical execution, and technical excellence.&quot;
                            </p>
                        </div>
                    </div>
                </section>
