            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
              <div className="max-w-2xl">
                ...
                <p className="text-slate-300 text-lg mb-6 leading-relaxed">
                  Step into the future of computation. This package bundles all 7 of our advanced quantum tracks—including Hardware, Algorithms, Sensing, Secure Communication, Information Theory, Post-Quantum Cryptography, and Quantum AI—into a single program.
                </p>
                <div className="flex flex-wrap gap-y-2 gap-x-6 text-sm text-slate-300 font-medium">
                  <div className="flex items-center gap-2">
                    <CheckCircle2 size={16} className="text-purple-400" />
                    7 Advanced Tracks Included
                  </div>
                  <div className="flex items-center gap-2">
                    <CheckCircle2 size={16} className="text-purple-400" />
                    Simulation & Circuit Design Labs
                  </div>
                  <div className="flex items-center gap-2">
                    <CheckCircle2 size={16} className="text-purple-400" />
                    Quantum Engineer Certification
                  </div>
                </div>
                ...
                <div className="mt-8 border-t border-white/10 pt-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {["Quantum Gates & Circuit Design", "Algorithms (Shor's, Grover's)", "High-Precision Metrology & Sensing", "Quantum Key Distribution (QKD)", "Post-Quantum Cryptography", "Quantum Machine Learning (QAI)"].map(pillar => (
              ...
              <div className="bg-white/5 backdrop-blur-md p-8 rounded-3xl border border-white/10 w-full lg:w-auto min-w-[280px] shrink-0 text-center lg:text-left flex flex-col justify-between">
                <div>
                  ...
                  <div className="flex items-baseline justify-center lg:justify-start gap-2 mb-6">
                    <span className="text-4xl md:text-5xl font-black text-white">{symbol}{COURSE_PRICING.professionalQuantumPackage.original[currency]}</span>
                  </div>
                </div>
                <Link
                  href="/apply?course=Quantum Computing Mastery Package"
