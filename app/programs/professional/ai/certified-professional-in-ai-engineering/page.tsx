                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <Link href="https://compass.thefoundrys.com/courses/ai/certified-professional-in-ai-engineering" className="px-8 py-4 bg-blue-600 text-white rounded-full font-bold text-lg hover:bg-blue-500 transition-all shadow-lg hover:shadow-blue-500/25 text-center">
                                    Enroll Now
                                </Link>
