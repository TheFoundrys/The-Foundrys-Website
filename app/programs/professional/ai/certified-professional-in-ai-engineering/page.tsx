    ...
    <main className="min-h-screen bg-slate-50 font-sans selection:bg-blue-100">
      ...
      <section className="py-20 px-6 bg-slate-50 border-y border-slate-200">
          <div className="container mx-auto max-w-5xl">
              <h2 className="text-3xl font-bold text-slate-900 mb-12 text-center">Skills You'll Master</h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <SkillItem title="Prompt Engineering" />
                <SkillItem title="LLM App Development" />
                <SkillItem title="Vector Search" />
                <SkillItem title="AI Agents" />
                <SkillItem title="Orchestration" />
                <SkillItem title="Model Deployment" />
              </div>
          </div>
      </section>
      ...
      <section className="py-20 bg-slate-900 overflow-hidden">
        <div className="container mx-auto px-6 mb-12 text-center">
             <h2 className="text-3xl font-bold text-white mb-4">Tools You Will Master</h2>
             <p className="text-slate-400">Industry standard technologies powered by modern AI stack</p>
        </div>
        ...
        <div className="flex w-full overflow-hidden">
            ...
            >
                ...
                {[1, 2, 3, 4].map((i) => (
                    <div key={i} className="flex items-center gap-12 text-slate-400 font-bold text-2xl uppercase tracking-widest">
      ...
      <section className="py-24 px-6 bg-slate-50">
           <div className="container mx-auto max-w-4xl text-center">
              <h2 className="text-3xl font-bold text-slate-900 mb-12">Who you can become</h2>
              <div className="flex flex-wrap justify-center gap-4">
                  <RoleBadge role="AI Engineer" />
                  <RoleBadge role="LLM Developer" />
                  <RoleBadge role="AI Application Architect" />
                  <RoleBadge role="Prompt Engineer" />
                  <RoleBadge role="Technical Product Manager (AI)" />
              </div>
           </div>
      </section>
...
function RoleBadge({ role }: { role: string }) {
    return (
        <span className="px-6 py-3 rounded-full bg-white border border-slate-200 text-slate-700 font-bold shadow-sm">
            {role}
        </span>
    )
}

function PersonaCard({ title, desc, icon: Icon }: { title: string, desc: string, icon: any }) {
    return (
        <div className="p-8 bg-white border border-slate-200 rounded-2xl hover:border-blue-200 hover:shadow-lg transition-all group">
...
function CareerCard({ icon: Icon, title, desc }: { icon: any, title: string, desc: string }) {
    return (
        <div className="p-8 bg-white rounded-2xl border border-slate-200 hover:border-emerald-200 transition-colors group">
