                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-12 flex-1 text-center lg:text-left w-full">
                            ...
                            <div className="lg:pr-4">
                                ...
                                <div className="flex items-center gap-2 justify-center lg:justify-start">
                                    <span className="text-sm text-slate-400 line-through">₹200,000</span>
                                    <span className="text-lg font-bold text-slate-900">₹100,000</span>
                                </div>
                            </div>
                        </div>
                ...
                <div className="container mx-auto max-w-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-lg text-slate-400 max-w-2xl mx-auto">
                            The definitive modern stack for Machine Learning Operations
                        </p>
                    </div>
