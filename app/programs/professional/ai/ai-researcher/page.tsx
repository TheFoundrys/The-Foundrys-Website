                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-3xl p-8 lg:p-10">
                            ...
                            <div className="flex items-baseline gap-3 mb-2">
                                ...
                                {pricing.original[currency] && pricing.original[currency] !== pricing.freshers[currency] && <span className="text-xl text-slate-500 line-through">{symbol}{pricing.original[currency]}</span>}
                            </div>
