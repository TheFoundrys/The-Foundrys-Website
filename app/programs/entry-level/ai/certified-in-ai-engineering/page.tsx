                ...
                <div className="mx-auto max-w-5xl">
                    <div className="bg-white rounded-2xl shadow-xl border border-slate-200 p-6 md:p-8 flex flex-col lg:flex-row items-center justify-between gap-6 md:gap-12">
                        <div className="grid grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-12 flex-1 text-center lg:text-left w-full">
                            ...
                            <div className="lg:pr-4">
                                ...
                                <div className="flex items-center gap-2 justify-center lg:justify-start">
                                    {pricing.original[currency] && pricing.original[currency] !== pricing.freshers[currency] && <span className="text-sm text-slate-400 line-through">{symbol}{pricing.original[currency]}</span>}
                        ...
                        <div className="w-full lg:w-auto">
                            <Link href="https://compass.thefoundrys.com/courses/ai/certified-in-ai-engineering" className="block w-full text-center px-8 py-3 bg-blue-600 text-white font-bold rounded-lg hover:bg-blue-500 transition-all shadow-lg hover:shadow-xl active:scale-95 whitespace-nowrap">
                                Enroll Now
                            </Link>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="border-l-4 border-emerald-400 bg-emerald-50/50 p-5">
                                    <h4 className="text-sm font-bold text-emerald-900 uppercase tracking-wider mb-2">The Goal</h4>
                                    <p className="text-base text-slate-700 font-light">
                                        This program bridges your gap. You won&apos;t just learn concepts; you will <span className="font-semibold text-emerald-900">ship production-grade AI apps</span>.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col md:flex-row gap-12 items-center mb-16">
                        ...
                        <div className="md:w-1/2 flex justify-end">
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-slate-700 bg-slate-800/50 text-slate-300 text-sm font-medium">
                                <CheckCircle2 size={16} className="text-blue-500" /> Real-World Architecture
                            </div>
                        </div>
                    </div>
