        ...
        <main className="min-h-screen bg-slate-50 font-sans selection:bg-blue-100">
                ...
                <div className="mx-auto max-w-5xl">
                    <div className="bg-white rounded-2xl shadow-xl border border-slate-200 p-6 md:p-8 flex flex-col lg:flex-row items-center justify-between gap-6 md:gap-12">
                        ...
                        <div className="w-full lg:w-auto">
                            <Link href="https://compass.thefoundrys.com/courses/ai/0-to-1-llm" className="block w-full text-center px-8 py-3 bg-blue-600 text-white font-bold rounded-lg hover:bg-blue-500 transition-all shadow-lg hover:shadow-xl active:scale-95 whitespace-nowrap">
                                Enroll Now
                            </Link>
                        </div>
                    </div>
            ...
            <section className="py-24 bg-gradient-to-br from-slate-50 via-blue-50/20 to-slate-50">
                <div className="container mx-auto px-6 max-w-6xl">
                    ...
                    <SyllabusMindMap
                        data={CURRICULUM_DATA.map(({ month, title, topics }) => ({ period: month, title, topics }))}
                        periodLabel="Month"
                        hubTitle="ZERO TO LLM"
                        theme="blue"
                    />
                </div>
            </section>
