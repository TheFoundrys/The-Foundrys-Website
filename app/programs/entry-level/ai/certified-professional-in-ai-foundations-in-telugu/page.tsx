        ...
        <main className="min-h-screen bg-slate-50 font-sans selection:bg-amber-100">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <Link href="/apply?course=Certified Professional in AI Foundations (in Telugu)" className="px-8 py-4 bg-amber-600 text-white rounded-full font-bold text-lg hover:bg-amber-500 transition-all shadow-lg hover:shadow-amber-500/25 text-center">
                                    Enroll Now
                                </Link>
            ...
            <section className="py-24 px-6 bg-slate-900 border-t border-slate-800">
                <div className="container mx-auto max-w-4xl text-center">
                    ...
                    <Link
                        href="/apply?course=Certified Professional in AI Foundations (in Telugu)"
