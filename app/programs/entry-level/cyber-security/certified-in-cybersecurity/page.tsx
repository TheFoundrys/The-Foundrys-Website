                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-12 flex-1 text-center lg:text-left w-full">
                            ...
                            <div className="lg:pr-4">
                                ...
                                <div className="flex items-center gap-2 justify-center lg:justify-start">
                                    <span className="text-lg font-bold text-slate-900">{symbol}{pricing.original[currency]}</span>
                                </div>
                            </div>
                        </div>

                        <div className="w-full lg:w-auto">
                            <Link href="https://compass.thefoundrys.com/courses/cyber-security/Certified-In-CyberSecurity(CC)" className="block w-full text-center px-8 py-3 bg-emerald-600 text-white font-bold rounded-lg hover:bg-emerald-500 transition-all shadow-lg hover:shadow-xl active:scale-95 whitespace-nowrap">
                                Enroll Now
                            </Link>
                        </div>
                    </div>
