                    ...
                    <div className="max-w-4xl pt-4">
                        ...
                        >
                            <div className="space-y-4">
                                <p className="text-sm font-bold text-blue-500 uppercase tracking-widest">Foundational Pathways</p>
                                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-white leading-tight">
                                    Start Your Journey in
                                    <br />
                                    <span style={{ backgroundImage: customGradient }} className={`${textGradientClass}`}>
                                        Emerging Tech
                                    </span>
                                </h1>
                            </div>
                            <p className="text-lg md:text-xl text-slate-300 mt-6 mb-10 leading-relaxed max-w-3xl font-normal">
                                Build a strong foundation in emerging technologies. Designed for beginners to master the core concepts of Artificial Intelligence, Cyber Security, Quantum Computing, and Blockchain.
                            </p>
                ...
                <div className="container mx-auto max-w-6xl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <DomainCard
                            ...
                            icon={<Network />}
                            onOpenPackage={() => setSelectedPackageId("entry-level-blockchain")}
                        />
                    </div>
                </div>
            </section>
...
function DomainCard({ title, tagline, desc, icon, onOpenPackage }: { title: string, tagline?: string, desc: string, icon: React.ReactElement, onOpenPackage: () => void }) {
    return (
        <motion.div
            initial={{ opacity: 0, y: 20 }}
