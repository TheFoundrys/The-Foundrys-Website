    ...
    <main className="min-h-screen bg-white select-none">
      ...
      <section className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
            <img 
                src="/venture-hero.jpg" 
                alt="Venture Building Accelerator" 
        ...
        <div className="container mx-auto max-w-6xl text-center relative z-10">
            <motion.div
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-md text-amber-400 text-sm font-bold uppercase tracking-wider mb-6 border border-white/20"
            >
                <Rocket size={16} />
