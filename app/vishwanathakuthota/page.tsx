...
export default function VishwanathAkuthotaProfile() {
    return (
        <main className="min-h-screen bg-slate-50 selection:bg-blue-100 selection:text-blue-900 overflow-x-hidden">
            <Navbar />
                    ...
                    <div className="flex flex-col md:flex-row gap-12 items-start">
                        ...
                        >
                            <div>
                                ...
                                <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold tracking-tight text-white mb-2 leading-tight">
                                    Vishwanath Akuthota
                                </h1>
                                ...
                                <div className="flex flex-wrap gap-3 mb-6">
                                    ...
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="inline-flex items-center gap-1 px-4 py-2 bg-blue-900/40 hover:bg-blue-900/60 text-white text-sm font-bold rounded-full transition-colors border border-blue-800/50"
                                    >
                                        <svg viewBox="0 0 110 136" fill="currentColor" className="w-4 h-4">
                                    ...
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="inline-flex items-center gap-1 px-4 py-2 bg-[#00ccbb]/20 hover:bg-[#00ccbb]/30 text-white text-sm font-bold rounded-full transition-colors border border-[#00ccbb]/30"
                                    >
