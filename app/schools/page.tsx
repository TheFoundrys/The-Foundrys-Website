...
import { ArrowRight, BrainCircuit, ShieldCheck, Atom, Network, Rocket, Lightbulb, Leaf, Zap, Globe, Cpu } from "lucide-react";
            ...
            <div className="container mx-auto max-w-7xl px-4 py-24 space-y-32 pb-32">
                ...
                <SchoolSection
                    ...
                    programs={[
                        ...
                        { title: "MBA in AI", desc: "Integrated 3+1", href: "/schools/certified-innovator", icon: Cpu, color: "text-indigo-400", bg: "bg-indigo-950/30", border: "border-indigo-500/20" },
                        { title: "MBA in Cybersecurity Venture Building", desc: "Integrated 3+1", href: "/schools/certified-innovator", icon: ShieldCheck, color: "text-indigo-400", bg: "bg-indigo-950/30", border: "border-indigo-500/20" },
                    ]}
                />
                ...
                <SchoolSection
                    ...
                    programs={[
                        { title: "ESG & Sustainability", desc: "Strategic Responsibility", href: "/schools/sustainability", icon: Leaf, color: "text-emerald-400", bg: "bg-emerald-950/30", border: "border-emerald-500/20" },
