...
export default function DataScienceSchoolPage() {
    ...
    return (
        <main className="min-h-screen bg-white text-slate-950 font-sans selection:bg-blue-100 overflow-x-hidden font-sans">
            <Navbar />
            ...
            {/* OUTCOMES & MILESTONES */}
            <section id="outcomes" className="py-24 px-6 overflow-hidden border-y relative" style={{ backgroundColor: "#DCE7F1", borderColor: "#c5d8ec" }}>
                <div className="container mx-auto max-w-[1450px]">
                            ...
                            <div className="flex flex-col gap-0 max-w-xl">
                                ...
                                <div className="grid grid-cols-[48px_1fr] gap-x-6 pb-10 relative group">
                                    ...
                                    <div className="pt-2.5 pb-2 cursor-default">
                                        ...
                                        <div className="text-sm text-slate-500 leading-relaxed font-normal">
